...
SET GIT_INSTALLER_EXE=Git-2.30.0.vfs.0.2-64-bit.exe
SET SCALAR_INSTALLER_EXE=SetupScalar.21.01.182.4.exe
SET WATCHMAN_CI_URL=https://github.com/facebook/watchman/releases/download/v2020.08.03.00/watchman-v2020.08.03.00-windows.zip
